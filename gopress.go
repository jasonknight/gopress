...
func (o *CommentMeta) Create() (int64, error) {
	...
	o.SetMetaId(o._adapter.LastInsertedId())
...
func (o *Comment) Create() (int64, error) {
	...
	o.SetCommentID(o._adapter.LastInsertedId())
...
func (o *Link) Create() (int64, error) {
	...
	o.SetLinkId(o._adapter.LastInsertedId())
...
func (o *Option) Create() (int64, error) {
	...
	o.SetOptionId(o._adapter.LastInsertedId())
...
func (o *Post) Create() (int64, error) {
	...
	o.SetID(o._adapter.LastInsertedId())
...
func (o *TermRelationship) Create() (int64, error) {
	...
	o.SetTermTaxonomyId(o._adapter.LastInsertedId())
...
func (o *Term) Create() (int64, error) {
	...
	o.SetTermId(o._adapter.LastInsertedId())
...
func (o *UserMeta) Create() (int64, error) {
	...
	o.SetUMetaId(o._adapter.LastInsertedId())
...
func (o *WooAttrTaxonomie) Create() (int64, error) {
	...
	o.SetAttrId(o._adapter.LastInsertedId())
...
func (o *WooDownloadableProductPerm) Create() (int64, error) {
	...
	o.SetPermissionId(o._adapter.LastInsertedId())
...
func (o *WooOrderItem) Create() (int64, error) {
	...
	o.SetOrderItemId(o._adapter.LastInsertedId())
...
func (o *WooTaxRateLocation) Create() (int64, error) {
	...
	o.SetLocationId(o._adapter.LastInsertedId())
...
func (o *WooTaxRate) Create() (int64, error) {
	...
	o.SetTaxRateId(o._adapter.LastInsertedId())
